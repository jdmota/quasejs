...
import { ComputationRegistry, Computation, CValue } from "../src/utils/computation-registry";
...
class C extends Computation<{ n: number }> {
  ...
  async getVal( dep: C ): Promise<number> {
    ...
    return value!.n; /* eslint-disable-line @typescript-eslint/no-non-null-assertion */
  }
