...
class GrammarTokenizer extends Tokenizer {
  ...
  token$lexer() {
    let $startMarker, $startPos=null, id=null, token=null, $0_t=null, $1_t=null, $2_t=null, $3_t=null, $4_t=null, $5_t=null, $6_t=null, $7_t=null, $8_t=null, $9_t=null, $10_t=null, $11_t=null, $12_t=null, $13_text=null, $14_num=null, $loc=null;
...
class GrammarParser extends Parser {
    ...
    if($ll1 === -1 /*#eof*/){
      ...
      if($ll2 === -1 /*#eof*/){
        ...
        if($ll3 === -1 /*#eof*/){
          ...
          $ff1 = this.ctx.ff(1);
          { //$ff1 === 3 /* A 8 */ || $ff1 === 9 /* Tricky2 2 */ || $ff1 === 10 /* Tricky2 6 */
            throw new Error("Ambiguity");
            $dd = 0;
            //Ambiguity
            $dd = 2;
          ...
          $ff1 = this.ctx.ff(1);
          if($ff1 === 3 /* A 8 */ || $ff1 === 9 /* Tricky2 2 */){
            $ff2 = this.ctx.ff(2);
            { //$ff2 === 0 /* $$START$$ 2 */ || $ff2 === 3 /* A 8 */ || $ff2 === 9 /* Tricky2 2 */ || $ff2 === 10 /* Tricky2 6 */
              throw new Error("Ambiguity");
              $dd = 0;
              //Ambiguity
              $dd = 2;
            ...
            { //$ff2 === 0 /* $$START$$ 2 */ || $ff2 === 3 /* A 8 */ || $ff2 === 9 /* Tricky2 2 */ || $ff2 === 10 /* Tricky2 6 */
              $ff3 = this.ctx.ff(3);
              { //$ff3 === 0 /* $$START$$ 2 */ || $ff3 === 3 /* A 8 */ || $ff3 === 9 /* Tricky2 2 */ || $ff3 === 10 /* Tricky2 6 */
                throw new Error("Ambiguity");
                $dd = 0;
                //Ambiguity
                $dd = 2;
  ...
  ruleGLL1() {
    ...
    $startPos = this.$getPos();
    $ll1 = this.$ll(1); $ll2 = this.$ll(2); $ll3 = this.$ll(3); 
    if(($ll1 === 1 /*#string:A*/ && $ll2 === 0 /*#string:O*/ && $ll3 === 12 /*#string:W*/)){
      this.ctx.p(30 /* GLL1 2 */, () => this.ruleGLLAux1());
    } else if(($ll1 === 2 /*#string:B*/ && $ll2 === 3 /*#string:C*/ && $ll3 === 0 /*#string:O*/)){
      this.ctx.p(31 /* GLL1 2 */, () => this.ruleGLLAux2());
    } else {
      this.$err();
    }
    this.$e(0 /*#string:O*/);
  ...
  ruleGLL1Follow() {
    ...
    this.ctx.p(32 /* GLL1Follow 3 */, () => this.ruleGLLAux1());
    $loc = this.$getLoc($startPos);
    return {$loc};
  }
  ruleGLL1FollowContext() {
    let $ll1, $ll2, $startPos=null, $loc=null;
    $startPos = this.$getPos();
    this.ctx.p(33 /* GLL1FollowContext 2 */, () => this.ruleGLL1Follow());
    this.ctx.p(34 /* GLL1FollowContext 3 */, () => this.ruleGLLAux1());
    $ll1 = this.$ll(1); $ll2 = this.$ll(2); 
    if(($ll1 === 1 /*#string:A*/ && $ll2 === 0 /*#string:O*/)){
      this.ctx.p(35 /* GLL1FollowContext 4 */, () => this.ruleGLLAux1());
  ...
  ruleGLL1Follow2() {
    ...
    if($dd === 0){
      1;
      this.ctx.p(36 /* GLL1Follow2 3 */, () => this.ruleGLLAuxOptional1());
    } else if($dd === 1){
      2;
    } else {
      this.$err();
  ...
  ruleGLL1FollowContext2() {
    let $startPos=null, $loc=null;
    $startPos = this.$getPos();
    this.ctx.p(37 /* GLL1FollowContext2 2 */, () => this.ruleGLL1Follow2());
    this.ctx.p(38 /* GLL1FollowContext2 3 */, () => this.ruleGLLAuxOptional1());
    this.$e(0 /*#string:O*/);
    $loc = this.$getLoc($startPos);
    return {$loc};
  }
  ruleGLLAuxOptional1() {
    ...
    if($ll1 === 0 /*#string:O*/){
      ...
      if($ll2 === 0 /*#string:O*/){
        ...
        { //$ll3 === 0 /*#string:O*/
          $ff1 = this.ctx.ff(1);
          { //$ff1 === 36 /* GLL1Follow2 3 */
            $ff2 = this.ctx.ff(2);
            { //$ff2 === 37 /* GLL1FollowContext2 2 */
              $dd = 1;
            }
          }
        }
