...
registerBuiltin(NeverType, (type, { typeBody, errorBody, compiler, opts }) => {
  opts.inline = true;
  typeBody.add(`never`);
...
registerBuiltin(NullType, (type, { typeBody, errorBody, compiler, opts }) => {
  opts.inline = true;
  typeBody.add(`null`);
  errorBody.add(compiler.helper("SchemaErrorTree"));
});
...
registerBuiltin(NumberType, (type, { typeBody, errorBody, compiler, opts }) => {
  opts.inline = true;
  typeBody.add(`number`);
  errorBody.add(compiler.helper("SchemaErrorTree"));
});

registerBuiltin(BigintType, (type, { typeBody, errorBody, compiler, opts }) => {
  opts.inline = true;
  typeBody.add(`bigint`);
  errorBody.add(compiler.helper("SchemaErrorTree"));
});
...
registerBuiltin(SymbolType, (type, { typeBody, errorBody, compiler, opts }) => {
  opts.inline = true;
  typeBody.add(`symbol`);
  errorBody.add(compiler.helper("SchemaErrorTree"));
});
