...
describe("unit", () => {
  ...
  it("fast bail", () => {
    ...
    let actual = [];
    let expected = ["before", "test", "bail", "after"];
  ...
  it("fast bail - error in before", () => {
    ...
    let actual = [];
    let expected = ["before", "before 2", "after"];
  ...
  it("error in serial sequence stops concurrent sequence", () => {
    ...
    let actual = [];
    let expected = ["beforeEach", "serial", "afterEach"];
