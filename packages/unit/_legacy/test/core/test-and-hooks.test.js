...
describe("unit", () => {
  it("error in before hook", () => {
    ...
    return runner.run().then(() => {
      ...
      expect(results[19].skipReason).toBe(
        "Failed because of an error in a previous hook."
      );
  ...
  it(".skip() in before hook", () => {
    ...
    let actual = [];
    let expected = ["before 1", "before 2", "after"];
  ...
  it("error in beforeEach hook", () => {
    ...
    let actual = [];
    let expected = ["group", "beforeEach", "afterEach"];
  ...
  it("skip + error in beforeEach hooks", () => {
    ...
    let actual = [];
    let expected = ["beforeEach 1", "beforeEach 2", "afterEach"];
  ...
  it("error in beforeEach causes other tests to be skipped", () => {
    ...
    let actual = [];
    let expected = ["beforeEach", "beforeEach 2", "afterEach"];
  ...
  it("error in beforeEach skips tests in the suite it was defined and in subsuites", () => {
    ...
    let actual = [];
    let expected = ["beforeEach", "afterEach"];
  ...
  it("error in afterEach skips tests in the suite it was defined and in subsuites", () => {
    ...
    let actual = [];
    let expected = ["beforeEach", "test", "afterEach"];
  ...
  it("skip in after hook", () => {
    ...
    let actual = [];
    let expected = ["before", "test", "after"];
