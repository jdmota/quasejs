...
import { SuiteStart, SuiteEnd, TestStart, TestEnd, Deferred, NormalizedOptions, RunEnd, RunStart } from "../types";
...
class Runner extends EventEmitter {
  ...
  matchesSnapshot( something: unknown, stack: string, key: string, deferred: Deferred<void> ) {
